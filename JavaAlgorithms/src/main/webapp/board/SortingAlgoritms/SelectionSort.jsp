...
<p>
	<strong>Selection Sort</strong> is a simple yet intuitive algorithm for sorting a list. In this algorithm, at each step, the smallest value from the unsorted part of the list is selected and moved to the front of the unsorted part.
	<br>
	While Selection Sort is straightforward and easy to understand, it is inefficient for large datasets. Its time complexity is always O(n^2), meaning the number of comparisons and swaps grows quadratically with the size of the list.
	<br>

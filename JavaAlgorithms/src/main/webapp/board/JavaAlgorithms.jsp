...
<link rel="icon" href="../resources/icon/java-32x32.png" sizes="32x32" type="image/png">
<link rel="icon" href="../resources/icon/java-16x16.png" sizes="16x16" type="image/png">
...
<link rel="icon" href="../resources/icon/java.ico">
...
<body>
	...
	<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
		<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="https://getbootstrap.kr/docs/5.3/examples/dashboard/#">Java Sorting Algorithm</a>
			...
			<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
				<div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
					<div class="offcanvas-header">
						<h5 class="offcanvas-title" id="sidebarMenuLabel">Java Sorting Algorithm</h5>
							...
							<div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									<ul class="nav flex-column">
										<li class="nav-item">
											<a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="https://getbootstrap.kr/docs/5.3/examples/dashboard/#">
												<svg class="bi">
	            ...
	            <a class="link-secondary" href="https://getbootstrap.kr/docs/5.3/examples/dashboard/#" aria-label="Add a new report">

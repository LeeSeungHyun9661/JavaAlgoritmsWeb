...
<body>
	...
	<h3>1. for 문</h3>
	<p><code>for</code> 문은 반복 횟수가 명확할 때 주로 사용됩니다. 초기화, 조건식, 증감식을 한 줄에 작성하여 반복을 제어합니다.</p>
	...
	<p>헤당 코드는 i가 5일 때 반복문을 탈출할 수 있도록 제어합니다.</p>
	...
	<p><code>continue</code>를 활용한다면 원하는 조건에서 반복문 실행을 건너뛰고 다시 처음으로 돌아갈 수 있도록 할 수 있습니다.</p>
	...
	<p><code>if</code> 문은 조건이 참일 때만 블록 안의 코드를 실행합니다.</p>
	<pre class="line-numbers">
	...
	<h2>
		4. <code>switch</code> 문
	</h2>
	<p><code>switch</code> 문은 하나의 변수 값에 따라 여러 경우(case)를 처리할 때 사용합니다. 각 <code>case</code>는 <code>break</code> 문으로 끝나며, <code>break</code> 문이 없으면 다음 <code>case</code>로 실행이 넘어갑니다.</p>
	<pre class="line-numbers">
	...
	<p>이제 1부터 1000까지의 값 중 모든 짝수의 합만 더하도록 코드를 짤 수 있습니다.</p>
